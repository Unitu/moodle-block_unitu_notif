This plugin provides the ability to display posts from Unitu’s Together We Changed (twc) in Moodle. There are two types of posts which can be viewed with this plugin:
